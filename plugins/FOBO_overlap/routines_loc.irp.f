           ...
           print*,i,j
            do m = 1, ao_num
             do k = 1, ao_num
              ...
              !if(dabs(cmoref(k,j,isym)*cmoref(m,i,isym)  * s(k,m,isym)).gt.1.d+3)then
              ! print*,i,j,k,m,cmoref(k,j,isym)*cmoref(m,i,isym)  * s(k,m,isym)
              ! print*,cmoref(k,j,isym),cmoref(m,i,isym)  , s(k,m,isym)
              !endif
             enddo
            enddo
         enddo
